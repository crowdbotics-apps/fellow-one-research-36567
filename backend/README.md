...
## Project Structure
    ...
    ├── fellow_one_research_36567  # Django project configurations
...
1. Clone this repo and `cd fellow_one_research_36567`
...
2. Clone this repo and `cd fellow_one_research_36567`
