...
export const globalOptions = {
  name: "fellow_one_research_36567",
  url: "https://fellow_one_research_36567.botics.co",
  api: "https://fellow_one_research_36567.botics.co/api/v1"
}
...
export const modulesOptions = {
  ...
  undefined: { title: title, path: path, styles: styles }
}
